...
<section id="intro">
    <div class="flex flex-row tablet:flex-col gap-6 justify-center items-center w-[80%] tablet:w-full">
        <div class="w-[50%] tablet:w-full pl-20 flex flex-col gap-3">
            ...
            <SocialIcons/>
            <a class="hover:bg-primary-800/20 border-l-4 border-secondary-400 bg-primary-900/30 shadow-lg rounded-md w-fit py-1 px-2" href="#projects" on:click={handleAnchorClick}>view my projects</a>
        </div>
        <div class="w-[50%] tablet:w-full">
            <img src={programmer_animated} alt="Animated Developer"/>
        </div>
    </div>
</section>